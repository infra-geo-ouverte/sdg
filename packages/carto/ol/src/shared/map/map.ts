...
export class SdgOlMap implements ISdgMap<olMap> {
  ...
  updateView(options: SdgOlViewOptions): void {
    const viewOptions: SdgOlViewOptions = {
      ...(this.view.getProperties() as SdgOlViewOptions),
      ...options
    };
   ...
   */
  setView(options: SdgOlViewOptions): void {
